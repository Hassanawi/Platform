                        ...
                        <div className="form-create-item">
                            ...
                            <form id="create-item-1" action="#" method="GET" acceptCharset="utf-8">
                                ...
                                <div className="input-group">
                                    ...
                                    <input id="comment-message" name="message" type="text" placeholder="Presale Link" required />
                                </div>
                                {/* <div className="input-group">
                                ...
                                {/* <p className="desc">Why are you reporting this presale?</p> */}
                                <textarea id="comment-message" name="message" tabIndex="4"
                                    placeholder="Why are you reporting this presale?" aria-required="true"></textarea>
                                ...
                                <div className="input-group">
                                    <p className="desc">Wallet Address: 0xc2e4954549795614946519496548589</p>
                                ...
                                <button name="submit" type="submit" id="submit"
                                    className="sc-button style letter style-2"><span>Submit Report</span> </button>
                            </form>
                        </div>
